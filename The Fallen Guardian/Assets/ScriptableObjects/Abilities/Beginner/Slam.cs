...
[CreateAssetMenu(menuName = "ScriptableObjects/Abilities/Beginner/Slam")]
public class Slam : ScriptableObject, IAbilityBehaviour
{
    ...
    IEnumerator AttackImpact(PlayerStateMachine stateMachine)
    {
        ...
        GameObject slash = Instantiate(SlashPrefab, stateMachine.transform.position + offset, stateMachine.AbilityDir, stateMachine.transform);
